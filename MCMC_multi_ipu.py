...
print("\nMCMC sampling example with Tensorflow Probability\n"
      ...
      f"Numer of burn-in steps {num_burnin_steps}\n" 
...
# Create num chips TF devices with 1 IPU per device 
config = utils.auto_select_ipus(config,[1]*num_ipus) #1 means there is only 1 IPU
